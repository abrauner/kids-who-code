...
// Diese Funktion schaltet erst alle LEDs aus und
// zeigt anschließend ein gelbes Licht an. Die Farb-LED
// wird auf Gelb gestellt.
function schalteAmpelGelb() {
    alleLEDsAus()
    basic.setLedColor(Colors.Yellow)
}
// Diese Funktion schaltet erst alle LEDs aus und
// zeigt anschließend ein rotes und ein gelbes Licht an. Die Farb-LED
// wird auf Gelb gestellt. Die LED-Matrix wird angeschaltet.
...
radio.onDataPacketReceived(({ receivedString }) => {
    // Wenn ein Fußgänger über die Straße gehen will müssen wir die Autos Rot schalten
    if (receivedString == "FUSSGAENGER_WUNSCH") {
        ...
        if (fussgaengerWunsch = false && receivedString == "FUSSGAENGER_ROT") {
            alleLEDsAus()
            // Schalte die Auto Ampel auf Gelb und warte 3 Sekunden
            schalteAmpelRotGelb()
